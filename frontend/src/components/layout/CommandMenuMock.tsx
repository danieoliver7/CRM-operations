export function CommandMenuMock() {
  return (
    <div className="glass group fixed bottom-4 left-4 right-4 z-50 flex max-w-[500px] cursor-text items-center gap-3 rounded-2xl border border-primary/20 p-3 shadow-2xl transition-all hover:border-primary/40 sm:bottom-6 sm:left-1/2 sm:right-auto sm:w-[calc(100vw-2rem)] sm:-translate-x-1/2 sm:gap-4 sm:p-4">
